"""
Script: train_model_svm.py
Descripción: Entrena y guarda el modelo SVM para reconocimiento
...
def main():
    print("=" * 50)
    print("ENTRENAMIENTO — MODELO SVM")
    ...
    # Entrenar
    print(f"\n🔧 Entrenando SVM (C={SVM_C}, kernel=linear)...")
    print("   (Esto puede tardar varios minutos...)")
    svm = SVC(C=SVM_C, kernel='linear', probability=True)
    ...
    print(f"\n📁 Modelo guardado en: {MODELS_DIR}/svm_model.pkl")
